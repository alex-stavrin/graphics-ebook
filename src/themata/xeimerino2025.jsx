...
export default function Xeimerino2025()
{
    return <div className="flex flex-col gap-3">
        ...
        <p>Έστω ότι έχουμε μια οθόνη που έχει διαστάσεις 4x4. Αυτο που θα κάνει το SSAA είναι να φτιάξουμε έναν μεγαλύτερο πίνακα. Δηλαδή να κάνουμε render σε μεγαλύτερη ανάλυση.
            Επειδή εδώ μας δίνει ο πίνακας της συνέλιξης να είναι 3x3 σημαίνει οτι θα κάνουμε render σε 12x12
        </p>
    </div> 
}
